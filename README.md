...
The unreleased `0.1.13` candidate adds generic event-identity, CI-receipt and
release-train contracts. It is not a public immutable ref until its tag,
...
alignment after publication and keeps the immutable rollback ref explicit.
Consumers should run the same self-test and package scan after updating their
pinned ref. Rollback is the immutable `v0.1.11` ref.
